...
export class AppComponent implements OnInit {
  displayedColumns = ['id', 'title', 'state', 'isInProd', 'created_at', 'updated_at', 'actions'];
  ...
  ngOnInit() {
    ...
    // this.httpService.get('./db.json').subscribe(
    //   data => {
    //     this.myDs = data as string [];	 // FILL THE ARRAY WITH DATA.
...
export class ExampleDataSource extends DataSource<Issue> {
  ...
  connect(): Observable<Issue[]> {
    ...
    return merge(...displayDataChanges).pipe(map( () => {
        ...
        //   const searchStr = (issue.id + issue.city + issue.description + issue.isAvailable).toLowerCase();
  ...
  sortData(data: Issue[]): Issue[] {
    ...
    return data.sort((a, b) => {
      ...
      switch (this._sort.active) {
        ...
        // case 'title': [propertyA, propertyB] = [a.city, b.description]; break;
        // case 'state': [propertyA, propertyB] = [a.city, b.description]; break;
